...
public class ChangeSeller extends AppCompatActivity {
...
Button registration101;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password101 = findViewById(R.id.password101);
        passwordcheck101 = findViewById(R.id.passwordcheck101);
        registration101 = findViewById(R.id.registration101);

        password101.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean hasFocus) {
                if (!hasFocus) {
                    password101.setBackground(ContextCompat.getDrawable(ChangeSeller.this, R.drawable.edittextborder));
                }else{
                    password101.setBackground(ContextCompat.getDrawable(ChangeSeller.this, R.drawable.redborderedit));
                }
        ...
        passwordcheck101.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean hasFocus) {
                if (!hasFocus) {
                    passwordcheck101.setBackground(ContextCompat.getDrawable(ChangeSeller.this, R.drawable.edittextborder));
                }else{
                    passwordcheck101.setBackground(ContextCompat.getDrawable(ChangeSeller.this, R.drawable.redborderedit));
                }
...
if(frompassword.length()>6 && frompasswordcheck.length()>6){
    if (frompasswordcheck.equals(frompassword)) {
        ...
        Toast.makeText(ChangeSeller.this, "Пароль обновлен!", Toast.LENGTH_LONG).show();
        GoodsSeller.fa.finish();
        Intent intent = new Intent(ChangeSeller.this, GoodsSeller.class);
        ...
        Toast.makeText(ChangeSeller.this, "Пароли должны совпадать", Toast.LENGTH_LONG).show();
    }
    ...
    private TextWatcher logintextwatcher = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if(textpassword.length()>0 && textpasswordcheck.length() > 0) {
                registration101.setBackground(ContextCompat.getDrawable(ChangeSeller.this, R.drawable.custombutton));
                registration101.setTextColor(getResources().getColor(R.color.colorWhite));
                registration101.setEnabled(true);
            }
            else {
                registration101.setBackground(ContextCompat.getDrawable(ChangeSeller.this, R.drawable.loginbuttonoff));
